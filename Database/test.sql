...
-- TESTING TRIGGER: AUTO-RESTOCK (Publisher Order)
...
-- TESTING TRIGGER: CONFIRM ORDER (Stock Update)
-- We will Confirm the order created in the previous test.
...
-- TESTING REPLENISHMENT HISTORY REPORT
